...
\begin{tikzpicture}[
    rect/.style={rectangle,,draw=black,text width=.5cm,text height=.25cm},
    none/.style={rectangle,draw=gray!20,text width=.5cm,text height=.25cm},
    nmbr/.style={font=\scriptsize,xshift=-.3cm,anchor=east}
]

\node[rect] at (0, 0) {};
\node[nmbr] at (0, 0) {Cucc};
